...
public class MultiModelHandler {
    ...
    public static void init() {
        // イベントハンドラに登録
        if (instance instanceof MultiModelHandler)
            return;
     ...
     * @param pEntityData
     */
    public void registerEntityClass(Class<? extends Entity> pEntityClass, Class<MultiModelData> pEntityData, String pModelName) {
